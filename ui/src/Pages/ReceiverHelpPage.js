...
class ReceiverHelpPage extends React.Component{
    ...
    render() {
        ...
        return (
            ...
            <p>
                В качестве движка преобразования данных запроса в текст используется <a href={"https://golangforall.com/en/post/templates.html"} target={"_blank"}>шаблоны языка Go</a>.
